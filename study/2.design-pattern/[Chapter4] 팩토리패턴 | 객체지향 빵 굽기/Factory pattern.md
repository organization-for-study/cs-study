...
###### &nbsp;- &nbsp; 단일 책임 원칙 준수
###### &nbsp;- &nbsp; 개방/폐쇠 원칙 준수
###### &nbsp;- &nbsp; 생성에 대한 이너페이스 부분과 생성에 대한 구현 부분을 따루 나누었기 대문에 패키지 분맇여 개별로 여러 개발자가 협업을 통해 개발
###### 2) 단점
###### &nbsp;- &nbsp; 형식 안전성에 지장이 있다. 
###### &nbsp;&nbsp;&nbsp; : 런타임 오류가 발생한다.
...
###### &nbsp;(1) &nbsp; 팩토리 메소드 패턴
###### &nbsp;&nbsp;- &nbsp; 상속으로 객체를 만든다.
###### &nbsp;&nbsp;- &nbsp; 객체를 생성할 때는 클래스를 확장하고 팩토리 메소드를 오버라이드한다.
###### &nbsp;&nbsp;- &nbsp; 서브클래스로 객체를 만들기 때문에 팩토리 메소드가 객체를 생성한다.
###### &nbsp;&nbsp;- &nbsp; 클라이언트와 구상 형식을 분리하는 역할을 한다.
###### &nbsp;(2) &nbsp; 추상화 팩토리 패턴
###### &nbsp;&nbsp;- &nbsp; 객체 구성으로 만든다.
###### &nbsp;&nbsp;- &nbsp; 제품군을 만드는 추상 형식을 제공한다.
###### &nbsp;&nbsp;- &nbsp; 제품이 생산되는 방식은 이 형식의 서브클래스에서 정의한다.
###### &nbsp;&nbsp;- &nbsp; 팩토리를 사용하고 싶으면 일단 인스턴스를 만든 다음 추상 형식을 써서 만든 코드를 전달한다.
###### &nbsp;&nbsp;- &nbsp; 팩토리 메소드 패턴을 쓸 때와 마찬가지로 클라이언트와 실제 구상 제품이 분리된다.
