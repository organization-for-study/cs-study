...
- 24/04/13 (AM 11:00)
    - ch15 : CompletableFuture와 리액티브 프로그래밍 컨셉의 기초 ( 이은영 )
    - ch16 : CompletableFuture : 안정적 비동기 프로그래밍 ( 장예진 )
    - ch17 : 리액티브 프로그래밍 ( 전다빈 )
    - 문제 ( 김현기 )
...
- 24/04/27 (AM 11:00)
    - ch18 : 함수형 관점으로 생각하기( 전다빈 )
    - ch19 : 함수형 프로그래밍 기법( 장예진 )
    - ch20 : OOP와 FP의 조화 : 자바와 스칼라 비교( 김현기 )
    - 문제 ( 이은영 )
